#Analyzing and maping of shops in Paris by :
# importing the JSON file "commerces" and the GEOJSON file "arrondissements"
# using tidyverse and ggmap libraries

library(tidyverse)

# Import
library(jsonlite)
shop = fromJSON("C:/Users/33665/Documents/portfolio/R/commerces.json", simplifyVector = FALSE)
...
library(geojsonio)
district = geojson_read("C:/Users/33665/Documents/portfolio/R/arrondissements.geojson", what = "sp")
